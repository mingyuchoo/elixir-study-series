defmodule Playa.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Playa.Repo)
  ...
  """
  def valid_password?(%Playa.Accounts.User{hashed_password: hashed_password}, password)
